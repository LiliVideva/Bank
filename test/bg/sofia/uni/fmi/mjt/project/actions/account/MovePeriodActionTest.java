...
public class MovePeriodActionTest {
	private static UserProfile userProfile;
	private static AccountsDatabase accounts;
	private static AccountAction movePeriodAction;
	...
	public static void setUpAll() throws IOException {
		...
		movePeriodAction = new MovePeriodAction(userProfile);
	}

	@Test
	public void testReceiveArgumentsReturnsNullWhenGivenNoArguments() {
		assertNull(movePeriodAction.receiveArguments(null));
	}

	@Test
	public void testReceiveArgumentsReturnsNullWhenGivenAnyArguments() {
		assertNull(movePeriodAction.receiveArguments("user"));
	}
	...
	public void testExecuteReturnsTrue() throws UserAlreadyLoggedException, IndexOutOfBoundsException,
		...
		assertTrue(movePeriodAction.execute(null, Status.CLERK, accounts));
	}
	...
	public void testExecuteActionReturnsFalseWhenGivenUserStatusClient() throws UserAlreadyLoggedException,
		...
		assertFalse(movePeriodAction.executeAction(null, userProfile, null, accounts));
	}
}
